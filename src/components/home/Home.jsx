        ...
        <div className="home__container container">
            ...
            <div className="home__img-wrapper">
                ...
                <p className="home__data home__data-one">
                    <span className="text-lg">1 <b>+</b></span>
            ...
            <p className="home__text">
                From Kerala, India. I have considerable amount of experience as
                web developer. I love to talk with you.
            </p>
